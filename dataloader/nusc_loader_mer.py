...
def init_data_loader(mode='train', shuffle=True, batch_size=4, num_workers=4, sample_index=0, nusc=None):    
    args_dataset = {'path_data_file': '/ws/rcdpt/datasets/nuscenes/prepared_data.h5',
                    'path_radar_file': '/ws/rcdpt/datasets/nuscenes/mer_2_30_5_0.5.h5',
                    'mode': mode,
